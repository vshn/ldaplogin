 ...
 */
/*
 *  Original source: ApacheDS "LdapServer" class.
 *  This code has been modified to avoid the use of a Keystore file.
 */
...
import org.apache.directory.server.ldap.handlers.request.*;
import org.apache.directory.server.ldap.handlers.response.*;
import org.apache.directory.server.ldap.handlers.sasl.MechanismHandler;
import org.apache.directory.server.ldap.replication.consumer.*;
...
public class TlsLdapServer extends LdapServer
{
     ...
     * @see {@link TlsLdapServer#MAX_SIZE_LIMIT_DEFAULT }
     */
    private long maxSizeLimit = MAX_SIZE_LIMIT_DEFAULT;

    /**
     * The maximum time limit.
     * @see {@link TlsLdapServer#MAX_TIME_LIMIT_DEFAULT }
     */
    ...
    {
        throw new NotImplementedException("TlsLdapServer does not implement reloadSslContext()");
    }
    ...
    public void start() throws Exception
    {
        ...
        while (iter.hasNext())
        {
            ...
            {
                chain = (new LdapsInitializer()).init( this, ( TcpTransport ) transport );
                if (chain == null) {
                    // If we can't initialize the TLS support then start without it
                    iter.remove();
                    continue;
                }
            }
